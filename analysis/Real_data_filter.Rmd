...
---
In this vignette we will load the data, pre-process it and analyse top first gene by p_beta parameter
...
Then we take the individual with most cells and take a look at the estimated parameters:
