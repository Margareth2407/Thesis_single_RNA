...
plot(dataset$genotype,dataset1$k_on, xlab="genotype", ylab="k_on estimate", main= "MLE without size parameter")

#k_off
plot(dataset$genotype,dataset$k_off, xlab="genotype", ylab="k_off estimate", main= "MLE with size parameter")
plot(dataset$genotype,dataset1$k_off, xlab="genotype", ylab="k_off estimate", main= "MLE without size parameter")

#k_r
plot(dataset$genotype,dataset$k_r, xlab="genotype", ylab="k_r estimate", main= "MLE with size parameter")
plot(dataset$genotype,dataset1$k_r, xlab="genotype", ylab="k_r estimate",main= "MLE without size parameter")
```
...
model11<- lm(k_on~dataset1$genotype, data=dataset)
model21<- lm(k_off~dataset1$genotype, data=dataset)
model31<- lm(k_r~dataset1$genotype, data=dataset)

plot(dataset$genotype,dataset$k_on, xlab="genotype", ylab="k_on estimate", main= "MLE with size parameter")
abline(model1, col="red")
plot(dataset1$genotype,dataset$k_on, xlab="genotype", ylab="k_on estimate", main= "MLE without size parameter")
abline(model11, col="red")

plot(dataset$genotype,dataset$k_off, xlab="genotype", ylab="k_off estimate", main= "MLE with size parameter")
abline(model2, col="red")
plot(dataset1$genotype,dataset$k_off, xlab="genotype", ylab="k_off estimate", main= "MLE without size parameter")
abline(model21, col="red")

plot(dataset$genotype,dataset$k_r, xlab="genotype", ylab="k_r estimate", main= "MLE with size parameter")
abline(model3, col="red")
plot(dataset1$genotype,dataset$k_r, xlab="genotype", ylab="k_r estimate", main= "MLE without size parameter")
